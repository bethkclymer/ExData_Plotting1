...
#This code was written to reproduce plot3 for the Exploratory Data Analysis course
...
png(filename="plot3.png") #generate the png plot (default size is 480px by 480px)
plot(data$DateTime, data$Sub_metering_1, type="l", col="black", ann=FALSE) #generate plot
lines(data$DateTime, data$Sub_metering_2, col="red") #add sub_metering_2
lines(data$DateTime, data$Sub_metering_3, col="blue") #add sub_metering_3
