...
#This code was written to reproduce plot2 for the Exploratory Data Analysis course
...
png(filename="plot2.png") #generate png file (default size is 480 px by 480 px)
